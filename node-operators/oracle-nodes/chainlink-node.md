...
If you are familiar with running Chainlink Oracle nodes, this information will get you started on the Moonbase Alpha TestNet quickly:
 ...
 - Get Moonbase Alpha tokens from [our Faucet](/builders/getting-started/moonbase-alpha/#discord-mission-control/)
...
The basic requirements are:
 ...
 - An account with funds. You can create one with [Metamask](/tutorials/moonbase-alpha/wallets/metamask/), which can be funded via [our Faucet](/builders/getting-started/moonbase-alpha/#discord-mission-control/)
 - Access to the Remix IDE in case you want to use it to deploy the Oracle contract. You can find more information about Remix on Moonbeam [here](/builders/tools/remix-ide/)
...
Go to the 'Configuration Page` and copy the node address. Use the [Moonbeam Faucet](/builders/getting-started/moonbase-alpha/#discord-mission-control/) to fund it.
...
The source code of the Oracle contract can be found in Chainlink's official GitHub repository [here](https://github.com/smartcontractkit/chainlink/tree/develop/contracts/src/v0.6). For this example, we'll use Remix to interact with Moonbase Alpha and deploy the contract. In Remix, we can copy the following code:
